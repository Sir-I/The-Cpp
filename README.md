# The-Cpp [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [![Track Awesome List](https://www.trackawesomelist.com/badge.svg)]
A curated list of awesome C++ (or C) frameworks, libraries, resources, and other captivating things.
...
## Database
*Database Libraries, SQL Servers, ODBC Drivers, & Tools*
